...
📞 *Butuh Bantuan?*
Hubungi kami di: ${getSetting('contact_whatsapp', '081290717151')}
...
*${getCompanyHeader()}*`,
    ...
    async sendNotification(phoneNumber, message, options = {}) {
        try {
            ...
            const footerInfo = footerSeparator + getSetting('footer_info', 'Powered by Nancy Global Solusi');
    ...
    async sendServiceDisruptionNotification(disruptionData) {
        try {
            ...
            const data = {
                ...
                support_phone: getSetting('support_phone', '081290717151')
            };
