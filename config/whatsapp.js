...
async function handleChangeSSID(senderNumber, remoteJid, params) {
    try {
        ...
        if (!device) {
            await sock.sendMessage(remoteJid, { 
                text: `${getSetting('company_header', 'NANCY BOT MANAGEMENT ISP')}
...
Mohon tunggu sebentar.${getSetting('footer_info', 'Internet Tanpa Batas')}`
        ...
        let responseMessage = `${getSetting('company_header', 'NANCY BOT MANAGEMENT ISP')}
...
Mohon tunggu sebentar.${getSetting('footer_info', 'Internet Tanpa Batas')}`
        ...
        const adminResponseMessage = `${getSetting('company_header', 'NANCY BOT MANAGEMENT ISP')}
...
_Perubahan selesai pada: ${new Date().toLocaleString()}_${getSetting('footer_info', 'Internet Tanpa Batas')}`;
        ...
        try {
            ...
            const customerNotificationMessage = `${getSetting('company_header', 'NANCY BOT MANAGEMENT ISP')}
...
Mohon tunggu sebentar.${getSetting('footer_info', 'Internet Tanpa Batas')}`
        ...
        // Pesan sukses untuk admin
        let adminResponseMessage = `${getSetting('company_header', 'NANCY BOT MANAGEMENT ISP')}
...
async function sendWelcomeMessage(remoteJid, isAdmin = false) {
    try {
        ...
        let welcomeMessage = `👋 *Selamat Datang di Bot WhatsApp ${getSetting('company_header', 'NANCY BOT MANAGEMENT ISP')}*\n\n`;
        ...
        // Tambahkan footer
        welcomeMessage += `🏢 *${getSetting('company_header', 'NANCY BOT MANAGEMENT ISP')}*\n`;
...
async function handleAdminMenu(remoteJid) {
    try {
        ...
        // Tambahkan footer
        adminMessage += `🏢 *${getSetting('company_header', 'NANCY BOT MANAGEMENT ISP')}*\n`;
