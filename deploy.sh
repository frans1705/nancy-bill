...
pm2 stop nancy-bill || true
pm2 delete nancy-bill || true
...
echo "  - Check status: pm2 status nancy-bill"
echo "  - View logs: pm2 logs nancy-bill"
echo "  - Restart: pm2 restart nancy-bill"
echo "  - Stop: pm2 stop nancy-bill"
echo ""
...
echo ""
echo "🎯 nancy Bill is now running on port 3002!"
echo "   Check: $(curl -s ifconfig.me || echo 'SERVER_IP'):3002"

# 14. Verifikasi
log_info "Verifying deployment..."
pm2 status nancy-bill
